...
public class Ex1ArrayAnalyzer {
    ...
    public int[] generateArray() {
        ...
        int size = random.nextInt(25,150);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Generated array of size: " + array.length);
        System.out.printf("Average: %.2f%n", average);
        System.out.println("Count above average: " + counts[0]);
        System.out.println("Count below average: " + counts[1]);
    }
}
